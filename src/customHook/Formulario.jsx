...
const Formulario = () => {
  ...
  return (
    <div className="container-formulario">
      <form className="fomulario" onSubmit={handleSubmit(onSumbit)}>
        ...
        <div className="formulario-input">
          <label className="form1">Telefono</label>
          <input
            className="form2"
            type="text"
            {...register("telefono", {
          ...
          {errors.telefono?.type === "maxLength" && (
            <p>debe tener 10 numeros</p>
          )}{" "}
        </div>

        <div className="formulario-input"> 
          <label className="form1">Correo</label>
          <input
            className="form2"
            type="text"
            {...register("Correo", {
